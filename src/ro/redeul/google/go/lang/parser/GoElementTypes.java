...
public interface GoElementTypes extends GoTokenTypes {
    ...
    GoElementType IMPORT_DECLARATION =
        new GoElementTypeImpl("ImportSpec");
    GoElementType CONST_DECLARATIONS =
        new GoElementTypeImpl("ConstDeclarations");
    ...
    GoElementType REL_EXPRESSION =
        new GoElementTypeImpl("RelationalExpression");
    GoElementType COM_EXPRESSION =
        new GoElementTypeImpl("CommunicationExpression");
    GoElementType LOG_AND_EXPRESSION =
        new GoElementTypeImpl("LogicalAndExpression");
    GoElementType LOG_OR_EXPRESSION =
        new GoElementTypeImpl("LogicalOrExpression");
    ...
    GoElementType TYPE_CHAN_BIDIRECTIONAL =
        new GoElementTypeImpl("TypeChanBidi");
    ...
    GoElementType INTERFACE_REFERENCE =
        new GoElementTypeImpl("interface type");
    GoElementType TYPE_STRUCT =
        new GoElementTypeImpl("TypeStruct");
    GoElementType TYPE_STRUCT_FIELD =
        new GoElementTypeImpl("TypeStructField");
    //    GoElementType TYPE_STRUCT_FIELD_ADDRESS = new GoElementTypeImpl("struct field address type");
    GoElementType TYPE_STRUCT_FIELD_ANONYMOUS =
        new GoElementTypeImpl("TypeStructFieldAnonymous");

    GoElementType FUNCTION_DECLARATION =
        new GoElementTypeImpl("FunctionDeclaration(f)");
    GoElementType METHOD_DECLARATION =
        new GoElementTypeImpl("MethodDeclaration");
    GoElementType METHOD_RECEIVER =
        new GoElementTypeImpl("MethodReceiver");
    GoElementType FUNCTION_PARAMETER_LIST =
        new GoElementTypeImpl("FunctionParameterList");
    GoElementType FUNCTION_PARAMETER =
        new GoElementTypeImpl("FunctionParameter");
    GoElementType FUNCTION_PARAMETER_VARIADIC =
        new GoElementTypeImpl("FunctionParameterVariadic");
    ...
    GoElementType SWITCH_TYPE_GUARD =
        new GoElementTypeImpl("SwitchTypeGuard");
    GoElementType SWITCH_TYPE_CASE =
        new GoElementTypeImpl("SwitchTypeCase");
    GoElementType SWITCH_EXPR_STATEMENT =
        new GoElementTypeImpl("SwitchExprStmt");
