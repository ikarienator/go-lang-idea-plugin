...
public final class GoTypeUntypedBool extends GoTypeUntyped<Boolean> {
    public GoTypeUntypedBool(Boolean value) {
        super(value);
    }

    @Override
    public boolean isIdentical(@NotNull GoType type) {
        return this == type || type instanceof GoTypeUntypedBool;
    }
